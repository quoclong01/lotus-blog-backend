...
router
  .route('/recommend')
  .get(jwtCheckNoRequired, postController.recommendIndex);
/**
 * @swagger
 *
 * /posts/recommend:
...
router
  .route('/comments/:id')
  .delete(jwtCheck, postController.deleteComment);
router
  .route('/recyclebin')
...
/**
  ...
  *               title:
  *                 type: string
  *                 example: title of post validate min 20 characters
  *               cover:
  *                 type: string
  *                 example: cover
  *               content:
  *                 type: string
  *                 example: content of post validate min 100 characters
  *               status:
  *                 type: string
  *                 example: public/private
  *               description:
  *                 type: string
  *                 example: description of post validate min 50 characters
  *               tags:
  *                 type: array
  *                 items:
  *                   type: string
